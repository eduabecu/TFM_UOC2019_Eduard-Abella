...
```
__Relfexión: parece que la empresa ha ofrecido un bono o algo por el estilo: la genete lo ha aprovecha y se ha ido__
...
__Reflexión: Cuando se afirma que un cliente se va, se tiene un 65% de acierto. Cuando realmente se van (según los datos), se tiene un 65/(65+95)% de predecirlo. El algoritmo tiende a asignar individuos a la categoria mayoritaria. Por este motivo, cuando se predice que sí se van se acierte normalemnte. Pero cuando realmente es que sí, no los identificas en muchas ocasiones.__
